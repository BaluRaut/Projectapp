...
function check_username(){
	...
	if(username.length > 2){
		$('#Loading').show();
		$.post("<?php echo base_url();?>index.php/admin/check_contacts", {
			username: $('#Email').val()
		} ,
                function(response){
			$('#Info').fadeOut();
...
echo form_open_multipart('admin/edit_contacts',$attributes);
?>
<input type="hidden" name="flag" value="add"/>

 <fieldset>
      <div id="legend" class="">
        <legend class="">Update Contacts </legend>
      </div>
	<input type="hidden" name="flag" value="add"/>
                <table> <tr> <td> 
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input placeholder="Department Name" class="input-xlarge" type="text"  ID="Detartment" name="Department" value=<?php echo @$Department;?> >
            <p class="help-block"></p>
          </div>
        </div>
                        </td> <td> 
    ...
    <div class="control-group">
          ...
          <!-- Text input-->
          <label class="control-label" for="input01">Country<sup style="color:red">*</sup></label>
          <div class="controls">
    ...
    <div class="control-group">
          ...
          <!-- Text input-->
          <label class="control-label" for="input01">State<sup style="color:red">*</sup></label>
          <div class="controls">
    ...
    <div class="control-group">
          ...
          <!-- Text input-->
          <label class="control-label" for="input01">City<sup style="color:red">*</sup> </label>
          <div class="controls">
...
</div><!--/.fluid-container--><?php include('getjs.php'); ?><?php
