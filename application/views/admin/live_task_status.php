                                         ...
                                         <td>
                                          ...
                                          <option value="All"><?php echo "All"; ?></option>
                                            <?php foreach($tasks as $t) { ?>
                                              ...
                                              <td>
                                            &nbsp; &nbsp; By User: 
                                           <select name="by_user_name" style="width:250px" 
 ...
 <?php   } ?>
    ...
    $(document).ready(function() { 
      //  loaddefault();
        ...
        $("#by_user_name").select2({ width: '120px'});
        $("#by_task_name").select2({ width: '202px' });
        
           $("#by_project_name").change(function() {
             
               $.ajax({
                url: '<?php echo site_url('/admin/current_running_task_ajax/');?>',
                type: 'POST',
                data :'project_name='+$('#by_project_name').val()+'&by_task_name='+$('#by_task_name').val()+'&by_user_name='+$('#by_user_name').val(),
                success: function(data) {
                    $("#datasheet").html(data);
                    }
                });            
