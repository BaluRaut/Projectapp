...
echo form_open_multipart('admin/edit_members',$attributes);
?>
<input type="hidden" name="flag" value="add"/>

 <fieldset>
      <div id="legend" class="">
        <legend class="">Update Member</legend>
      </div>
	<input type="hidden" name="flag" value="add"/>
        <table> <tr> <td> 
        <div class="control-group">
          ...
          <div class="controls">
              <Select name="is_member">
                     <option value="Free"  <?php if ($member_type!=="paidmember") echo 'selected="selected"';?>  >Free Member </option> 
                     <option value="Paid"  <?php if ($member_type=="paidmember") echo 'selected="selected"';?>  >Paid Member </option>
              </select>
    ...
    <div class="control-group">
		  ...
		  <?php echo form_error('Password'); ?>
            <input placeholder="password" class="input-xlarge" type="text" value="<?php echo @$Password; ?>" name="Password" ID="Password"  >
    ...
    <div class="control-group">
		...
		<div class="control-group" style="margin-right:123px;" >
