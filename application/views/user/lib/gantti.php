...
class Gantti {
  ...
  function render() {
    ...
    foreach($this->blocks as $i => $block) {
      ...
      $st=($block['st']==NULL) ? '0':$block['st'];
      $html[] = '<span class="gantt-block' . $class . '" style="left: ' . $left . 'px; width: ' . $width . 'px; height: ' . $height . 'px"><strong class="gantt-block-label">' . $days . '  &nbsp; &nbsp; ('.$st.'% )</strong></span> ';
      $html[] = '</li>';
